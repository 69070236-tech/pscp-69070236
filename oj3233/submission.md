...
```text
The problem is to determine whether the lottery is a winner
...
Constraints: The lottery consists of two parts: 1. a letter 2. 5 numbers
```
...
```text
1. Read the inputs
2. Use if-else to check case by case
3. Print the result
```
...
Read the inputs, check case by case, and print the result.
```
...
```text
Win the last two numbers and the same letter
```
