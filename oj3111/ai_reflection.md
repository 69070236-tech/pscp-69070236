...
| OJ submission ID, if submitted | 623340 |
| OJ status | Pass |
...
```text
I asked AI what was wrong with my code.
```
...
```text
Gemini told me that it could be Floating Point Imprecision or IndexError, so it suggested finding a way to calculate without using floats.
```
...
```text
I fix 0.95 and 0.97 to 95/100 and 95/100 in my calculation.
```
...
```text
I learned about floating-point imprecision. If possible, try not to multiply floating-point numbers; there are other ways to do it.
```
