...
| Item | Answer |
|---|---|
| OJ problem number/title | OJ3238 - Elon Musk (X-shape) |
| OJ submission ID, if submitted | 632025 |
| OJ status | Pass |
...
```text
I asked Gemini to help me solve the dynamic ASCII X-shaped characters.
```
...
```text
I read the problem wrong, and I can calculate the distance from the center. Also, the ord() and chr() functions.
```
...
```text
I coded the static X-shape on my own.
```
...
```text
The ord() and chr() functions, and pay more attention to the question.
```
