...
| Item | Answer |
|---|---|
| OJ problem number/title | OJ3064 - วันเกิด |
| OJ submission ID, if submitted | 572161 |
| OJ status | Pass |
...
```text
I ask Gemini to look at my code's logic and untangle the messiness of it.
```
...
```text
My code is a mess. I separated days, months, and years, and it's complicated. I asked if I should rewrite my code, and it said that's not a bad idea, so Gemini suggested me to use the datetime module instead.
```
...
```text
I asked Gemini more about how to use datetime, and I understand that it works like numbers, so I applied it to my original code.
```
...
```text
I learned about the datetime module. All I have to do is assign datetime.date(day, month, year) to a variable to get the date. Now I can use it like numbers.
```
