...
| Item | Answer |
|---|---|
| OJ problem number/title | OJ3297 - ตั๋วหนังสุดป่วน |
| OJ submission ID, if submitted | 637377 |
| OJ status | Pass |
...
```text
I asked Claude to find the hidden test case.
```
...
```text
I don't have to use a break in the no-seat case.
```
...
```text
I coded everything myself, except for finding the last part and polishing my code
```
...
```text
Read the problem carefully, especially the constraints.
```
