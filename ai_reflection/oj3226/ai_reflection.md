...
| Item | Answer |
|---|---|
| OJ problem number/title | OJ3226 - [Recommend] Inflation |
| OJ submission ID, if submitted | 610092 |
| OJ status | Pass |
...
```text
I asked Gemini for the cause of the overflow error and asked Claude for a way to fix the error.
```
...
```text
Multiplying floats can cause imprecise decimal places, and decimal places have a limit.
```
...
```text
I wrote my first plan and coded my I/O myself.
```
...
```text
Separated money into baht and satang, use int instead of float to calculate, and:.02d to pad a number.
```
