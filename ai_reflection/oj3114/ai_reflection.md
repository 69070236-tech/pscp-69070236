...
| Item | Answer |
|---|---|
| OJ problem number/title | OJ3114 - Suvarnabhumi Airport Parking |
| OJ submission ID, if submitted | 623674 |
| OJ status | Pass |
...
```text
I used Gemini to verify my code and find a hidden test case, and Claude to find a hidden test case. 
```
...
```text
Gemini helps me simplify the logic instead of separating hours and minutes. Claude helps me find that one hidden test case.
```
...
```text
I did everything by myself until I got stuck on the hidden test, so I changed my logic and fixed the hidden test case with help. 
```
...
```text
I learned to simplify the logic and to think about the scope of unclear problems.
```
